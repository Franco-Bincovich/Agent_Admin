...
def build_prompt(
    ...
    return (
        ...
        "- Slide 'portada': campo 'contenido' es str — subtítulo o descripción breve.\n"
        "- Slide 'destacado': campo 'contenido' es str — texto destacado del slide.\n"
        "- Slide 'cierre': campo 'contenido' es str — si el documento tiene próximos pasos o conclusiones, incluilos aquí. Si no hay información específica, escribí una frase de cierre ejecutivo relevante al contenido del documento. NUNCA dejes este campo vacío.\n"
        "- TODOS los slides deben tener contenido sustancial — "
        "nunca dejes el campo 'contenido' vacío o como string vacío.\n"
        "- Si un slide no tiene suficiente información del documento fuente, "
        "sintetizá los puntos más relevantes del contexto general.\n"
        f"{bloque_imagenes}\n"
        "## OUTPUT REQUERIDO\n"
